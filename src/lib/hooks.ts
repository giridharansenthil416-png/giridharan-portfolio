...
export function usePrefersReducedMotion() {
  ...
  useEffect(() => {
    // Only reduce motion if specifically forced in local storage or debug
    const forced = typeof window !== 'undefined' && window.localStorage.getItem('reduced-motion') === 'true'
    setReduced(forced)
  }, [])
